...
namespace EngineCoreProject.Controllers.Queue
{
    ...
    public class QueueController : ControllerBase
    {
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [HttpGet("process")]
        public async Task<ActionResult> GetProcess(string processNo, int serviceKindNo)
        {
        ...
        public async Task<ActionResult> ChangeTicketsStatusToInProgressByProcessNo(string processNo)
        {
            bool res = true;
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [HttpGet("PickTicket")]
        public async Task<ActionResult> Get(string processId, int serviceKindNo, DateTime dateTime, bool bookTicket)
        {
